...
//! adapters must return unsupported until RFC-054+/RFC-055+." No parsing
//! logic of any kind — every method returns
//! [`StructureErrorKind::UnsupportedFeature`].
//!
//! `JsonAdapter` moved out of this file in RFC-054 J2, to
//! `crate::formats::json`, once it stopped being a stub.
